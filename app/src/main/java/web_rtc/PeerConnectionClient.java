...
import web_rtc.AppRTCClient.SignalingParameters;
...
//        }
    ...
    private void createPeerConnectionInternal(EglBase.Context renderEGLContext) {
        ...
        // mute voice
//        Log.d("voiceAyham", ":"+  mediaStream.audioTracks.size());
...
//        PeerConnectionFactory.shutdownInternalTracer();
    ...
    public void setRemoteAudioEnabled(final boolean enable) {
        executor.execute(() -> {
            enableRemoteAudio = enable;
    ...
    public static class PeerConnectionParameters {
        ...
        public static PeerConnectionParameters createDefault() {
            return new PeerConnectionParameters(false/*true*/, false,
                    false, 0, 0, 0,
                    0, "VP8",
                    /*true*/false,
                    false,
